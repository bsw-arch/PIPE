# Getting Started with Release Management Bot

This guide will help you get started with the **pipe-release-bot** autonomous AI agent.
...
```bash
# Check bot status
pipe-release-bot --status

# Run health check
pipe-release-bot --health
```
...
pipe-release-bot test --keragr

# Test coordination API
pipe-release-bot test --coordination
```
...
pipe-release-bot start --mode learning

# Check logs
tail -f logs/pipe-release-bot.log
```
...
2. Review logs in `logs/pipe-release-bot.log`
3. Verify network connectivity to META-KERAGR
4. Ensure all dependencies are installed

## Support

- **Issues**: [Report on Codeberg](https://codeberg.org/PIPE-Bots/pipe-release-bot/issues)
