# PIPE BUILD AUTOMATION BOT Wiki

Welcome to the Build Automation Bot wiki - your comprehensive guide to autonomous platform intelligence.

## 🧠 Overview

The **pipe-build-bot** is an autonomous Augmentic AI agent that manages build processes, artifact generation, and build optimisation. This wiki provides complete documentation for installation, configuration, usage, and integration.
...
MIT Licence - See [LICENCE](https://codeberg.org/PIPE-Bots/pipe-build-bot/src/branch/main/LICENCE)
