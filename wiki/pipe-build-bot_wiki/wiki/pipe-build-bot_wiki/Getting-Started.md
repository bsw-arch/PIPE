# Getting Started with Build Automation Bot

This guide will help you get started with the **pipe-build-bot** autonomous AI agent.
...
```bash
# Check bot status
pipe-build-bot --status

# Run health check
pipe-build-bot --health
```
...
pipe-build-bot test --keragr

# Test coordination API
pipe-build-bot test --coordination
```
...
pipe-build-bot start --mode learning

# Check logs
tail -f logs/pipe-build-bot.log
```
...
2. Review logs in `logs/pipe-build-bot.log`
3. Verify network connectivity to META-KERAGR
4. Ensure all dependencies are installed

## Support

- **Issues**: [Report on Codeberg](https://codeberg.org/PIPE-Bots/pipe-build-bot/issues)
