...
openbao policy write pipe-test-bot - <<EOF
...
echo "✅ Policy 'pipe-test-bot' created"
echo ""
...
openbao write database/roles/pipe-test-bot \
...
# Create PKI role
openbao write pki/roles/pipe-test-bot \
...
echo "  2. Deploy with Helm: helm install pipe-test-bot iac/helm/charts/pipe-test-bot"
