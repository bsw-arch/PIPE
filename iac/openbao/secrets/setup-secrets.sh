...
openbao policy write pipe-build-bot - <<EOF
...
echo "✅ Policy 'pipe-build-bot' created"
echo ""
...
openbao write database/roles/pipe-build-bot \
...
# Create PKI role
openbao write pki/roles/pipe-build-bot \
...
echo "  2. Deploy with Helm: helm install pipe-build-bot iac/helm/charts/pipe-build-bot"
