...
openbao policy write pipe-security-bot - <<EOF
...
echo "✅ Policy 'pipe-security-bot' created"
echo ""
...
openbao write database/config/axis-postgres \
    ...
    allowed_roles="pipe-security-bot" \
...
openbao write database/roles/pipe-security-bot \
...
# Create PKI role
openbao write pki/roles/pipe-security-bot \
...
echo "  2. Deploy with Helm: helm install pipe-security-bot iac/helm/charts/pipe-security-bot"
