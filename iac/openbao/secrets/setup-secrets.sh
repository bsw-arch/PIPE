...
openbao policy write pipe-integration-bot - <<EOF
...
echo "✅ Policy 'pipe-integration-bot' created"
echo ""
...
openbao write database/config/axis-postgres \
    ...
    allowed_roles="pipe-integration-bot" \
...
openbao write database/roles/pipe-integration-bot \
...
# Create PKI role
openbao write pki/roles/pipe-integration-bot \
...
echo "  2. Deploy with Helm: helm install pipe-integration-bot iac/helm/charts/pipe-integration-bot"
