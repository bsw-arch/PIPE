...
openbao policy write axis-task-bot - <<EOF
...
echo "✅ Policy 'axis-task-bot' created"
echo ""
...
openbao write database/roles/axis-task-bot \
...
# Create PKI role
openbao write pki/roles/axis-task-bot \
...
echo "  2. Deploy with Helm: helm install axis-task-bot iac/helm/charts/axis-task-bot"
