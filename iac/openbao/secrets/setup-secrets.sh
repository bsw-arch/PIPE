...
openbao policy write pipe-release-bot - <<EOF
...
echo "✅ Policy 'pipe-release-bot' created"
echo ""
...
openbao write database/config/axis-postgres \
    ...
    allowed_roles="pipe-release-bot" \
...
openbao write database/roles/pipe-release-bot \
...
# Create PKI role
openbao write pki/roles/pipe-release-bot \
...
echo "  2. Deploy with Helm: helm install pipe-release-bot iac/helm/charts/pipe-release-bot"
